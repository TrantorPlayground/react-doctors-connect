...
import {Button, Col, Form, Input, notification, Row, Select, Space, Spin} from "antd";
...
const Register: React.FC = () => {
    ...
    return (
        <Spin spinning={loading}>
            <Form labelAlign={'left'} labelCol={{xs: 24, lg: 6}} colon={false} initialValues={{
                role: 'patient'
                ...
                <Form.Item label={'Email/Username'} rules={[{
                    required: true,
